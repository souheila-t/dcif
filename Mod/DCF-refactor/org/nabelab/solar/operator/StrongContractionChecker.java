...
public class StrongContractionChecker extends OpChecker implements Tags {
   ...
   */
  public StrongContractionChecker(Env env, Tableau tableau) {
    super(env, tableau);
  }
  ...
  public boolean check(Node node, Operators ops) {
    if (node.hasTag(CONTRACTIBLE))
      ops.add(new StrongContraction(env, node));
    return true;
  }
