 ...
 *
 */
public class UnitAxiomMatching extends Operator {

  /**
   * Constructs a unit axiom matching operator which is applied to the specified node.
   * @param env    the environment.
   * @param node   the specified node.
   * @param uaxiom the unit axiom.
   */
  public UnitAxiomMatching(Env env, Node node, Clause uaxiom) {
    super(env, node);
    this.uaxiom = uaxiom;
    this.mandatory = true;
  }
   ...
   */
  public void cancel() {
    node.removeTag(UNIT_AXIOM_MATCHED);
    super.cancel();
  }

  /**
   * Returns the unit axiom.
   * @return the unit axiom.
   */
  ...
  public ProofStep convert() {
    return new UnitAxiomMatchingStep(env, uaxiom);
  }
  ...
  /** The unit axiom which complementary subsumes the node. */
  private Clause uaxiom = null;
}
