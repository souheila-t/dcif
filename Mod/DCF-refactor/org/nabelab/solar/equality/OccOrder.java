...
public class OccOrder implements Comparator<Signature> {

  /**
   * Construct a comparetor based on the frequency.
   * @param freqTable
   */
  public OccOrder(TermFreqTable freqTable) {
  ...
  public int compare(Signature sig1, Signature sig2) {
    ...
    return freqTable.get(sig2.getType(), sig2.getID()) -  freqTable.get(sig1.getType(), sig1.getID());
  }
