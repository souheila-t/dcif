...
public class VarCounter {
  ...
  /**
   * Sets the specified variable to this counter.
  ...
  /**
   * Returns the maximum variable name.
   * @return
   */
  ...
  /**
   * Returns the number of kinds of variables.
   * @return the number of kinds of variables.
   */
  public int size() {
    return size;
  }
