...
import org.nabelab.solar.operator.UnitLemmaMatching;

/**
 * @author nabesima
 *
 */
public class UnitLemmaMatchingStep extends ProofStep {

  /**
   * Constructs a unit lemma proof step.
   * @param env    the environment.
   * @param clause the used unit lemma.
   */
  public UnitLemmaMatchingStep(Env env, Conseq clause) {
    super(env);
    this.clause = clause;
  }

  /**
   * Returns the proof of this unit lemma.
   * @return the proof of this unit lemma.
   */
  public Proof getProof() {
    return clause.getProof();
  }
  ...
  public Operator convert(Tableau tableau, Node node) {
    return new UnitLemmaMatching(env, node, clause);
  }
  ...
  public String toString() {
    return "unit lemma matching with " + clause;
  }
  
  /** The unit lemma. */
  private Conseq clause = null;
