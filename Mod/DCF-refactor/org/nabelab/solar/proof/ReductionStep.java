...
import org.nabelab.solar.operator.Reduction;

/**
 * @author nabesima
 *
 */
public class ReductionStep extends ProofStep {
   ...
   */
  public ReductionStep(Env env, int genes) {
    super(env);
    this.genes = genes;
  }
  ...
  public Operator convert(Tableau tableau, Node node) {
    ...
    if (g == null)
      return null;
    return new Reduction(env, node, target, g);
  }
