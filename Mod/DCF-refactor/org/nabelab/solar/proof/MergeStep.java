...
import org.nabelab.solar.operator.Merge;
 ...
 *
 */
public class MergeStep extends ProofStep {

  /**
   * Construct a merge step.
   * @param env    the environment.
   * @param target the target literal of this merge operation. 
   */
  public MergeStep(Env env, Literal target) {
    super(env);
    this.target = target;
  }
  ...
  public String toString() {
    return "merge with " + target;
  }
  
  /** The target literal of this merge operation. */
