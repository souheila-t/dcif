...
public class Disjunction extends Constraint {
   ...
   * @param disjunct the list of constraints.
   */
  public Disjunction(Env env, Node node, int type, HashSet<Constraint> disjunct) {
    super(env, node, type);
   ...
   */
	public void instantiate() {
		for (Constraint constraint : disjunct)
  ...
  private HashSet<Constraint> disjunct = null;
