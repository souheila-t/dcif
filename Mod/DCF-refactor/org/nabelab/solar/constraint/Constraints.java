...
//    }
  ...
  /**
   * Returns the set of constraints whose values are unknown.
   * @return the set of constraints whose values are unknown.
   */
  public List<Constraint> getUnknowns() {
    List<Constraint> unknowns = new ArrayList<Constraint>();
  	for (Constraint c : elements)
  		if (c.check() == Constraint.UNKNOWN)
      	unknowns.add(c);
  	return unknowns;
  }
  ...
  /**
   * Instantiates all variables in this constraints.
   */
