...
public class ROccOrder implements Comparator<Signature> {

  /**
   * Construct a comparetor based on the frequency.
   * @param freqTable
   */
  public ROccOrder(TermFreqTable freqTable) {
  ...
  public int compare(Signature sig1, Signature sig2) {
    ...
    return freqTable.get(sig1.getType(), sig1.getID()) -  freqTable.get(sig2.getType(), sig2.getID());
  }

  /** A term frequency table. */
  private TermFreqTable freqTable = null;
}
