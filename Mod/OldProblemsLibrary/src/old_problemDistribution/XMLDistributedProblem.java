...
import old_solarInterface.CFSolver;
import old_solarInterface.IndepPField;
import old_solarInterface.SolProblem;
import old_logicLanguage.UnitClauseCNF;
import old_mars.reasoning.LocalTheory;
...
public double getCurrentRuleRedundancy() {
	...
	public static void main(String[] args) throws ParseException
	{
		...
		for (int i=0;i<pb.nbAgents;i++){
	       ...
	       ** 2. Si les 2 agents ne sont pas connect�s, trouver le plus court chemin entre eux
	       ** 2.b reporter les �l�ments communs dans les langages de ce chemin
	       * 
	       * 
	       */
