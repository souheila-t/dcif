 ...
 *
 */
public class NegVarRenameMap extends VarRenameMap {
  ...
  /** 
   * Returns the minimum variable number.
   * @return the minimum variable number.
   */
  public int getMinVar() {
    return -(super.getMaxVar() + 1);
  }
}
