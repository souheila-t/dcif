...
//      if (stats.inf() == 36)
//        System.out.println("Hello" + stats.inf());
//      if (stats.inf() == 12)
//        System.out.println("Hello" + stats.inf());
  ...
  public long getCPUTime() {
    return (threadMxBean.getThreadCpuTime(thread) / 1000000) - startTime;
  }
...
//        }      
  ...
  public final static String VERSION = "SOLAR (SOL for Advanced Reasoning) 2.0 alpha (build 311)";
