 ...
 *
 */
public class NegationAsFailureChecker extends OpChecker {

  /**
   * Constructs a negation as failure checker.
   * @param env       the environment.
   * @param tableau   the tableau.
   */
  public NegationAsFailureChecker(Env env, Tableau tableau) {
    super(env, tableau);
  }
  ...
  public boolean check(Node node, Operators ops) {
    if (node.hasNAF())
      ops.add(new NegationAsFailure(env, node));
    return true;
  }
