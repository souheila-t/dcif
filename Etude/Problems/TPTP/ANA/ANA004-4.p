%--------------------------------------------------------------------------
% File     : ANA004-4 : TPTP v6.1.0. Released v1.0.0.
% Domain   : Analysis
...
% Rating   : 0.33 v6.1.0, 0.29 v5.5.0, 0.38 v5.4.0, 0.50 v5.2.0, 0.30 v5.1.0, 0.27 v5.0.0, 0.50 v4.1.0, 0.38 v4.0.1, 0.40 v4.0.0, 0.43 v3.4.0, 0.50 v3.3.0, 0.33 v3.1.0, 0.50 v2.7.0, 0.25 v2.6.0, 0.33 v2.5.0, 0.00 v2.4.0, 0.20 v2.3.0, 0.33 v2.2.1, 0.25 v2.1.0, 0.37 v2.0.0
% Syntax   : Number of clauses     :   13 (   4 non-Horn;   1 unit;  12 RR)
