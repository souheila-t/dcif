%------------------------------------------------------------------------------
% File     : ANA027-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Analysis
...
% Rating   : 0.60 v6.1.0, 0.64 v6.0.0, 0.50 v5.5.0, 0.80 v5.3.0, 0.83 v5.2.0, 0.75 v5.1.0, 0.76 v5.0.0, 0.79 v4.1.0, 0.77 v4.0.1, 0.73 v3.7.0, 0.70 v3.5.0, 0.73 v3.4.0, 0.75 v3.3.0, 0.79 v3.2.0
% Syntax   : Number of clauses     : 2809 ( 249 non-Horn; 649 unit;1988 RR)
%            Number of atoms       : 6176 (1289 equality)
%            Maximal clause size   :    7 (   2 average)
%            Number of predicates  :   87 (   0 propositional; 1-3 arity)
%            Number of functors    :  239 (  46 constant; 0-18 arity)
%            Number of variables   : 5878 (1184 singleton)
