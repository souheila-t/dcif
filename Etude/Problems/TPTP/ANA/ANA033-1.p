%------------------------------------------------------------------------------
% File     : ANA033-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Analysis
...
% Rating   : 0.90 v6.1.0, 1.00 v6.0.0, 0.90 v5.5.0, 1.00 v5.4.0, 0.95 v5.3.0, 1.00 v5.2.0, 0.94 v5.0.0, 1.00 v3.2.0
% Syntax   : Number of clauses     : 2795 ( 248 non-Horn; 650 unit;1980 RR)
%            Number of atoms       : 6141 (1283 equality)
%            Maximal clause size   :    7 (   2 average)
%            Number of predicates  :   87 (   0 propositional; 1-3 arity)
%            Number of functors    :  242 (  47 constant; 0-18 arity)
%            Number of variables   : 5826 (1183 singleton)
