%------------------------------------------------------------------------------
% File     : ANA017-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Analysis
...
% Rating   : 0.80 v6.1.0, 0.93 v6.0.0, 1.00 v3.2.0
% Syntax   : Number of clauses     : 2790 ( 248 non-Horn; 647 unit;1976 RR)
%            Number of atoms       : 6129 (1283 equality)
%            Maximal clause size   :    7 (   2 average)
%            Number of predicates  :   87 (   0 propositional; 1-3 arity)
%            Number of functors    :  240 (  47 constant; 0-18 arity)
%            Number of variables   : 5818 (1183 singleton)
