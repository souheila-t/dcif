...
import org.nabelab.solar.operator.EqResolution;
 ...
 *
 */
public class EqResolutionStep extends ProofStep {

  /**
   * Constructs a reduction step.
   * @param env the environment.
   */
  public EqResolutionStep(Env env) {
    super(env);
  }
  ...
  public Operator convert(Tableau tableau, Node node) {
    ...
    if (lit.isNegEqualPred()) {
      ...
      if (g != null) 
        return new EqResolution(env, node, g);
    }    
  ...
  public String toString() {
    return "reduction with " + genes + " generations";
  }
