...
import org.nabelab.solar.operator.UnitAxiomMatching;

/**
 * @author nabesima
 *
 */
public class UnitAxiomMatchingStep extends ProofStep {

  /**
   * Constructs a unit axiom proof step.
   * @param env    the environment.
   * @param clause the used unit axiom.
   */
  public UnitAxiomMatchingStep(Env env, Clause clause) {
    super(env);
    this.clause = clause;
  }
  ...
  public Operator convert(Tableau tableau, Node node) {
    return new UnitAxiomMatching(env, node, clause);
  }
  ...
  public String toString() {
    return "unit axiom matching with " + clause;
  }
