...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncher.jar -verbose  -method=$met -var=_all_ld-1-4 -t=600000 $file.sol $file.csv 
		echo "######################################"	&>> LOG_File.log	
done
...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncher.jar -verbose  -method=$met -var=_all_ld-1-4 -dist=_kmet2 -t=600000 $file.sol $file.csv 
		echo "######################################"	&>> LOG_File.log	
done
...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncher.jar   -method=$met -var=_all_ld-1-4 -dist=_kmet4 -t=600000 $file.sol $file.csv 
		echo "######################################"	&>> LOG_File.log
done
...
#do
		...
		#java -d64 -Xms512m -Xmx8g -jar CFLauncher.jar  -method=$met -var=_all_ld-1--1 -dist=_kmet6 -t=600000 $file.sol $file.csv 
		#echo "######################################"	&>> LOG_File.log
#done
...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncher.jar   -method=$met -var=_all_ld-1-4 -dist=_kmet8 -t=600000 $file.sol $file.csv 
		echo "######################################"	&>> LOG_File.log
done
