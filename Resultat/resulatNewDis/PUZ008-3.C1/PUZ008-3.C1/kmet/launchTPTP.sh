...
#do
		...
		#java -d64 -Xms512m -Xmx8g -jar CFLauncherVF.jar -verbose  -method=$met -var=_all_ld-1--1 -t=600000 $fileN.sol $fileN.csv 
		#echo "######################################"	&>> LOG_File.log	
#done
...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncherVF.jar -verbose  -method=$met -var=_all_ld-1--1 -dist=_kmet2 -t=600000 $fileN.sol $fileN.csv 
		echo "######################################"	&>> LOG_File.log	
done
...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncherVF.jar   -method=$met -var=_all_ld-1--1 -dist=_kmet4 -t=600000 $fileN.sol $fileN.csv 
		echo "######################################"	&>> LOG_File.log
done
...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncherVF.jar  -method=$met -var=_all_ld-1--1 -dist=_kmet10 -t=600000 $fileN.sol $fileN.csv 
		echo "######################################"	&>> LOG_File.log
done
...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncherVF.jar   -method=$met -var=_all_ld-1--1 -dist=_kmet8 -t=600000 $fileN.sol $fileN.csv 
		echo "######################################"	&>> LOG_File.log
done
