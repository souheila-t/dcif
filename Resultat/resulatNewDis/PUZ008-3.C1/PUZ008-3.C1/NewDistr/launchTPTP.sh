...
METHOD4=(DICF-PB-Star DICF-PB-NewAsync DICF-PB-Star-FixedRoot-1 DICF-PB-Star-FixedRoot-2 DICF-PB-Token DICF-PB-Async DICF-PB-Token-FixedOrder-2-1-0 DICF-PB-Token-FixedOrder-2-1-0 DICF-PB-Token-FixedOrder-1-0-2 DICF-PB-Token-FixedOrder-0-2-1 DICF-PB-Token-FixedOrder-1-2-0 DICF-PB-Token-FixedOrder-2-0-1 DICF-PB-Token-FixedOrder-1-2-0 ) 
...
#do
		...
		#java -d64 -Xms512m -Xmx8g -jar CFLauncher.jar -verbose  -method=$met -var=_all_ld-1--1 -t=600000 $fileN.sol $fileN.csv 
		#echo "######################################"	&>> LOG_File.log	
#done
...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncher.jar -verbose  -method=$met -var=_all_ld-1--1 -dist=_wagent2 -t=600000 $fileN.sol $fileN.csv 
		echo "######################################"	&>> LOG_File.log	
done
...
do
		...
		java -d64 -Xms512m -Xmx8g -jar CFLauncherVF.jar   -method=$met -var=_all_ld-1--1 -dist=_wagent3 -t=600000 $fileN.sol $fileN.csv 
		echo "######################################"	&>> LOG_File.log
done
...
#do
		...
		#java -d64 -Xms512m -Xmx8g -jar CFLauncher.jar   -method=$met -var=_all_ld-1--1 -dist=_kmet8 -t=600000 $fileN.sol $fileN.csv 
		#echo "######################################"	&>> LOG_File.log
#done
